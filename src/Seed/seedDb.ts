...
const dummyArtifacts: IArtifact[] = [
  {
    ...
    profilePicture: "https://media.istockphoto.com/id/483369699/photo/burial-mask-of-the-egyptian-pharaoh-tutankhamun.jpg?s=2048x2048&w=is&k=20&c=mGJD5PINfJnGItNZc9VoICWnvCJCs1G_jKYUrffQzQI=",
    sections: [
      {
        title: "Discovery",
    ...
    pdfs: ["https://www.adobe.com/support/products/enterprise/knowledgecenter/media/c4611_sample_explain.pdf"],
    mediaGallery: [
    ...
    externalURL: "https://en.wikipedia.org/wiki/Mask_of_Tutankhamun",
    createdAt: new Date(),
  },
  {
    ...
    profilePicture: "https://images.unsplash.com/photo-1440711085503-89d8ec455791?q=80&w=1998&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    sections: [
      {
        title: "History",
    ...
    externalURL: "https://en.wikipedia.org/wiki/Knightly_sword",
    createdAt: new Date(),
  },
];
