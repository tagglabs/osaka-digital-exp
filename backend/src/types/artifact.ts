...
export const sectionSchema = z.object({
  title: z.string().nonempty({ message: "Section title is required" }),
  titleJap: z.string().optional(),
  content: z.string().nonempty({ message: "Section content is required" }),
...
export const artifactSchema = z.object({
  ...
  artifactName: z.string().nonempty({ message: "Artifact name is required !" }),
